...
public class MemberCartActivity extends BaseActivity implements ShopcartExpandableListViewAdapter.CheckInterface, View.OnClickListener, ShopcartExpandableListViewAdapter.ModifyCountInterface, SwipeRefreshLayout.OnRefreshListener {
...
//        children.clear();
    ...
    private void initEvents() {
        footer = LayoutInflater.from(mContext).inflate(R.layout.home_cart_footview, null);
        ...
        mExListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                IntentUtils.intentTo(mContext, linkUrl, "", webUrl);
                return true;
            }
        });
    }
