...
public class MyHuaTiActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_hua_ti);
        initUI();
    }
    ...
    private void initData(int pageNum, final boolean isloadmore) {
        RetrofitUtil.getInstance().GetBoardlist(openid, "", "mytopic", String.valueOf(pageNum), new Subscriber<BaseResponse<BoardListModel>>() {
            @Override
    ...
    public class HuaTiAdapter extends BaseQuickAdapter<BoardListModel.ListBean, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, BoardListModel.ListBean item) {
            ...
            BorderTextView tvAttention = helper.getView(R.id.tv_attention);
