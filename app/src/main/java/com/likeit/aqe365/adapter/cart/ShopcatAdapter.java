...
public class ShopcatAdapter extends BaseExpandableListAdapter {
    ...
    private Map<String, List<CartListModel.ListBeanXX.ListBeanX>> childrens;
    ...
    public ShopcatAdapter(List<CartListModel.ListBeanXX> groups, Map<String, List<CartListModel.ListBeanXX.ListBeanX>> childrens, Context mcontext) {
        this.groups = groups;
    ...
    public Object getChild(int groupPosition, int childPosition) {
        List<CartListModel.ListBeanXX.ListBeanX> childs = childrens.get(groups.get(groupPosition).getId());
...
//        }
        ...
        final CartListModel.ListBeanXX.ListBeanX child = (CartListModel.ListBeanXX.ListBeanX) getChild(groupPosition, childPosition);
        if (child != null) {
            childViewHolder.goodsName.setText(child.getTitle());
            childViewHolder.goodsPrice.setText("￥" + child.getMarketprice() + "");
            childViewHolder.goodsNum.setText(String.valueOf(child.getTotal()));
            ImageLoader.getInstance().displayImage(child.getThumb(), childViewHolder.goodsImage);
            childViewHolder.goods_size.setText(child.getOptiontitle());
            //设置打折前的原价
...
//    }
    ...
    private class GroupViewClick implements View.OnClickListener {
        private CartListModel.ListBeanXX group;
        private int groupPosition;
        private TextView editor;

        public GroupViewClick(CartListModel.ListBeanXX group, int groupPosition, TextView editor) {
            this.group = group;
