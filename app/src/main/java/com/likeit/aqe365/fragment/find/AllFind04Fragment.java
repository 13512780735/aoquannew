...
public class AllFind04Fragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void lazyLoad() {
        SharedPreferencesUtils.put(getActivity(),"findFlag","4");
        initUI1();
    }
...
//        String lng = SharedPreferencesUtils.getString(getContext(), "lng");
        RetrofitUtil.getInstance().Postlist(openid, String.valueOf(pageNum), "", lat, lng, "isdistance", "", "", new Subscriber<BaseResponse<PostListModel>>() {
            @Override
