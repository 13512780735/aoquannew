...
public class MoodCommentFragment extends DialogFragment {
    EditText edContent;
    ...
    private void post() {
        ...
        RetrofitUtil.getInstance().moodreply(openid, pid, bid, rpid, mpid, content, new Subscriber<BaseResponse<EmptyEntity>>() {
            @Override
