 ...
 */
public class UserInfo02Fragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected int setContentView() {
        return R.layout.fragment_user_info02;
    }
