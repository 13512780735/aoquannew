package com.likeit.aqe365.fragment.mycoupon;
 ...
 */
public class Coupon02Fragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected int setContentView() {
        return R.layout.fragment_coupon02;
    }
    ...
    public void initData(int pageNum,  final boolean isloadmore) {
        RetrofitUtil.getInstance().GetCouponList(openid, "used",String.valueOf(pageNum), new Subscriber<BaseResponse<CouponListModel>>() {
            @Override
