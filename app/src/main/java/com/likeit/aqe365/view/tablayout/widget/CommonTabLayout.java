package com.likeit.aqe365.view.tablayout.widget;
...
import com.likeit.aqe365.view.tablayout.manager.FragmentChangeManager;
import com.likeit.aqe365.view.tablayout.utils.UnreadMsgUtils;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(16f));
        mTextsize1 = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(28f));
    ...
    private void addTab(final int position, View tabView) {
        ...
        TextView iv_tab_icon = (TextView) tabView.findViewById(R.id.iv_tab_icon);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            iv_tab_icon.setTextColor(i == mCurrentTab ? mTextSelectColor : mTextUnselectColor);
            //iv_tab_icon .setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextsize1);
            iv_tab_icon .setTextSize(20);
            if (mIconVisible) {
                iv_tab_icon.setVisibility(View.VISIBLE);

                CustomTabEntity tabEntity = mTabEntitys.get(i);
              //  iv_tab_icon.setText("&#xe699");
                iv_tab_icon.setText(tabEntity.getTabSelectedIcon());
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (mTextBold == TEXT_BOLD_WHEN_SELECT) {
                ...
                iv_tab_icon.getPaint().setFakeBoldText(isSelect);
            }
        }
    }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public TextView getIconView(int tab) {
