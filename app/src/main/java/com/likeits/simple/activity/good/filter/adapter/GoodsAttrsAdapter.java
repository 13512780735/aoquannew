package com.likeits.simple.activity.good.filter.adapter;
...
public class GoodsAttrsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (data.get(position).isChecked()) {
            ...
            myView.attr.setTextColor(Color.parseColor("#ff424d"));
        } else {
            myView.attr.setBackgroundResource(R.drawable.goods_attr_unselected_shape);
            myView.attr.setTextColor(Color.parseColor("#656565"));
        }
        return v;
    }
