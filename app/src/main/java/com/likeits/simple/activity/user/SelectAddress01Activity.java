...
import com.likeits.simple.activity.cart.EditAddressActivity;
...
public class SelectAddress01Activity extends BaseActivity {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.ivEditAddress.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(SelectAddress01Activity.this, EditAddressActivity.class);
                    Bundle bundle = new Bundle();
