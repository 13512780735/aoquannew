 ...
 * describe:  右边适配器
 */
public class RightAdapter2 extends BaseQuickAdapter<GoodsCategoryModel.ListBean.TwotierBean, BaseViewHolder> {

    public RightAdapter2(int layoutResId, List<GoodsCategoryModel.ListBean.TwotierBean> data) {
        super(R.layout.item_medical_tv, data);
    }

    @Override
    protected void convert(final BaseViewHolder baseViewHolder, final GoodsCategoryModel.ListBean.TwotierBean item) {
