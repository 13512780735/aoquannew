 ...
 */
public class Comment02Fragment extends BaseFragment {
...
//    SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    protected int setContentView() {
        return R.layout.fragment_comment02;
    }
    ...
    private void initData() {
        LoaddingShow();
        RetrofitUtil.getInstance().GetCommentList(id, "good", new Subscriber<BaseResponse<GoodCommentmodel>>() {
            @Override
