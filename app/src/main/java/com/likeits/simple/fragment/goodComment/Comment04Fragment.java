 ...
 */
public class Comment04Fragment extends BaseFragment {
...
//    SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    protected int setContentView() {
        return R.layout.fragment_comment04;
    }
    ...
    private void initData() {
        LoaddingShow();
        RetrofitUtil.getInstance().GetCommentList(id, "bad", new Subscriber<BaseResponse<GoodCommentmodel>>() {
            @Override
