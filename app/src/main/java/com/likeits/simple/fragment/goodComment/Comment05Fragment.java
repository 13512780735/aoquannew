 ...
 */
public class Comment05Fragment extends BaseFragment {
...
//    SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    protected int setContentView() {
        return R.layout.fragment_comment05;
    }
    ...
    private void initData() {
        LoaddingShow();
        RetrofitUtil.getInstance().GetCommentList(id, "pic", new Subscriber<BaseResponse<GoodCommentmodel>>() {
            @Override
